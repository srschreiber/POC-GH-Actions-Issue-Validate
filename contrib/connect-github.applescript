# Usage: osascript connect-github.applescript <FIDO-ENDPOINT> <VPN-PROFILE>
# E.g.:
# osascript ./connect-github.applescript https://fido-challenger.githubapp.com/auth/vpn-prod github-iad-prod
...
on is_on_auth_form(t)
  tell application "Google Chrome"
    tell t to execute javascript "document.forms[0].lastElementChild.innerText.startsWith('AUTHORIZE ME')"
  end tell
end is_on_auth_form
...
on run argv
  tell application "Google Chrome"
    tell first window
      set tokenWindow to make new tab with properties {URL:item 1 of argv}
  ...
  tell application "Viscosity" to connect item 2 of argv
